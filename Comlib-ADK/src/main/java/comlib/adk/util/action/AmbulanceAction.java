...
public class AmbulanceAction extends Action {
    ...
    public static Message unload(Tactics tactics, int time) {
    ...
    public static Message load(Tactics tactics, int time, EntityID target) {
    ...
    public static Message rescue(Tactics tactics, int time, EntityID target) {
